...
pixi add catalystcoop.ferc_xbrl_extractor
# for installing globally
pixi global install catalystcoop.ferc_xbrl_extractor
```
...
It is possible to list all of the versions of `catalystcoop.ferc_xbrl_extractor` available on your platform:
...
```
pixi search catalystcoop.ferc_xbrl_extractor --channel conda-forge
```
